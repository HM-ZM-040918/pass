...
const UUID = process.env.UUID || 'd8bd6d87-a38b-4ec3-8870-4e693bbb5a5d'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'ip.mh996.cf';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '5555';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'L0MPgNUBMgmrfsvDhH';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'wispbyte.mh996.tk';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZWYzYmE3OWY1Nzc5NTU5NTc1ZDU4Mzc0MzZkMGU5YWIiLCJ0IjoiYTZhNGU2YTAtMDUxNS00M2ZmLWIzNjgtY2NjMDdiOTU3MDNlIiwicyI6IllXRTJaV1F3Wm1JdE1XUmhNaTAwTldJMUxUZ3dZVE10TVRkallXSTROMlU0WkdReSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
